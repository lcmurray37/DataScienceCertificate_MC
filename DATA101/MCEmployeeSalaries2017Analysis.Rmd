---
title: "Montgomery Country Employee Salaries of 2017 Analysis"
author: "Lucy Murray"
date: "6/13/2019"
output:
...
csv_file <- paste0(local_dir, "Employee_Salaries_-_2017.csv")
```
...
```{r}
empsalaries2017 <- read.csv(csv_file,  stringsAsFactors = FALSE)
```
